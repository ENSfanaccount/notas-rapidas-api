...
<div class="container py-4">
    ...
    <p class="text-muted mb-4">Gestiona tus tickets de soporte desde aquí.</p>

    <div class="d-flex gap-2 mb-4">
        <a href="{{ route('usuario.tickets.create') }}" class="btn btn-primary">+ Nuevo Ticket</a>
        <a href="{{ route('usuario.tickets.index') }}" class="btn btn-outline-primary">Ver Mis Tickets</a>
    </div>

    <h5>Últimos tickets</h5>
    <table class="table table-bordered">
        <thead class="table-light">
            <tr><th>Número</th><th>Descripción</th><th>Estado</th></tr>
        </thead>
        <tbody>
            ...
            @empty
            <tr><td colspan="3" class="text-center text-muted">No tienes tickets aún.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
